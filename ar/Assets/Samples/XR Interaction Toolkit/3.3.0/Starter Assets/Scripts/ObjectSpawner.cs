...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.StarterAssets
{
    ...
    {
        // ★ 추가: 현재 화면에 띄워져 있는 단 하나의 객체를 추적합니다.
...
// ★ 추가: 이미 소환된 객체가 있다면 파괴(삭제)하여 화면에서 없앱니다.
            ...
            // ★ 추가: 방금 새로 만든 객체를 변수에 저장해 둡니다. (다음에 지우기 위해)
        ...
        {
            // ★ 추가: 이미 소환된 객체가 있다면, 바닥을 터치해도 아무 일도 일어나지 않고 종료합니다.
            if (m_CurrentSpawnedObject != null)
            {
